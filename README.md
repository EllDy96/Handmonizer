...
We use the model called Handpose (https://learn.ml5js.org/#/reference/handpose)(https://learn.ml5js.org/#/reference/handpose) that performs hand-skeleton finger tracking. It takes the video stream frame by frame and returns the coordinates of 21 hand keypoints over the palm of the hand as shown in this figure.
...
Based on the coordinates of these 21 points we compute three main parameters
  ...
  3. The hand orientation: computed as the slope of the white lines between $[0, \pi]$. 
